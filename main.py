...
# Calculate ROI
roiii_mba = int(total_salary / corresponding_value)  * 100
...
st.write("ROI of studying at",selected_option,":",(int(total_salary_float/corresponding_value)*100),"%")
...
# Calculate ROI
roiii_basl = int(total_salary_basl / basl_investment)  * 100

...
st.subheader('Business education should be about making better decisions. Let us help you make a decision in 2024 that could impact the long term returns on your investment in a business program.')
st.subheader('The tool below is an ROI calculator that enables you to select a B-school and understand the difference between the ROI of the Kraftshala BLP program and a Business-program from the selected school.')
